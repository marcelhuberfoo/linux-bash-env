...
BLANK="\$(test -n \"\${__git__ps__info[branchstring]}\" && echo \" \")"
...
unset NORMALCOLOR BLANK LBRACKET RBRACKET BRANCHCOLOR DIRTYCOLOR INDEXCOLOR STASHEDCOLOR UNTRACKEDCOLOR REBASECOLOR UPSTREAMCOLOR
